...
const Dashboard = () => {
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-gray-900 text-white p-6 text-center">
        <div>
          ...
          <button onClick={() => navigate('/')} className="mt-6 bg-orange-500 px-6 py-2 rounded-full">
            Back to Home
          </button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 overflow-y-auto pb-24">
      ...
      <div className="grid gap-6">
        {menuItems.map((item, index) => (
          <motion.div
            ...
            className={`relative overflow-hidden cursor-pointer rounded-3xl p-8 bg-gradient-to-br ${item.color} shadow-xl text-white`}
          >
            ...
            <div className="relative z-10 flex justify-between items-start">
              <div>
                ...
                <p className="text-white/80 font-medium max-w-[200px]">{item.desc}</p>
              </div>
              <div className="bg-white/20 p-3 rounded-full">
                {/* FIX: SVG path was missing the 'M' command — d="9 5l7 7-7 7"
                    is invalid SVG. The arrow was invisible/broken.
                    Correct path is d="M9 5l7 7-7 7" */}
